...
wandb.init(project="bigbird", entity="mlm")
...
att_block_size=3 #8 ->changed for viz
...
def MLM_training():
    ...
    #trainer.train(resume_from_checkpoint="/home/jvanschalkwyk/lustre/mlm/output/bb_final_zu_stride/checkpoint-14000")
    trainer.train()
    evaluation(trainer)
    trainer.save_model('/home/jvanschalkwyk/lustre/mlm/saved/bigbird_small_zu')
